...
class DecisionCreate(BaseModel):
    ...
    final_action: Action = Field(
        ...,
        description="Final action chosen by the human reviewer (may differ from agent recommendation).",
    )
    ...
    reason: str | None = Field(
        default=None,
        description="Required when decision_type is OVERRIDE. Explains why the recommendation was changed.",
    )

    # Timestamp is system-generated by default, but we keep it on the model for audit trail purposes.
    ...
    def _require_reason_when_overridden(self) -> "DecisionCreate":
        ...
        if self.decision_type == DecisionType.OVERRIDE and not (self.reason and self.reason.strip()):
