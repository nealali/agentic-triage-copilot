...
class DecisionCreate(BaseModel):
    ...
    # "specify" is required when final_action is OTHER.
    # This allows reviewers to provide details about what "OTHER" action they're taking.
    specify: str | None = Field(
        default=None,
        description=(
            "Required when final_action is OTHER. Provides details about what specific action is being taken."
        ),
    )
    ...
    def _require_reason_when_overridden(self) -> "DecisionCreate":
        ...
        - If the final_action is OTHER, a specify field must be provided.
        """
        ...
        if self.final_action == Action.OTHER and not (self.specify and self.specify.strip()):
            raise ValueError("specify is required when final_action is OTHER")
